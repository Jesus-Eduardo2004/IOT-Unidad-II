...
# Configuración del sensor MQ2 (Gas)
mq2_sensor = ADC(Pin(34))  # Pin analógico del sensor
...
def leer_gas():
    ...
    gas_ppm = (valor / 4095) * 1000  # Conversión aproximada a PPM
    return gas_ppm
...
while True:
    try:
        ...
        gas_ppm = leer_gas()
        print(f"[INFO] Concentración de gas: {gas_ppm:.2f} PPM")
